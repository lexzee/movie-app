...
const TvSeries = () => {
  ...
  const handleSearch = (e: {target: {value: SetStateAction<string>}}) => {
    ...
    const newList = movies.filter((movie) => movie.title.toLowerCase().includes(search.toLowerCase()) && movie.category === "TV Series")
        ...
        {search === "" ?
         <Box width={"100%"}>
          <Box width={"100%"}>
            ...
            <MovieList recommendedList = {search === "" ? Series : searchList} />
          </Box>
         </Box>
         :
         <Box width={"100%"}>
