...
const Movie = () => {
  ...
  const { movies } = state;
  const Movies = movies.filter(movie => movie.category === "Movie")
  ...
  const handleSearch = (e: {target: {value: SetStateAction<string>}}) => {
    ...
    const newList = movies.filter((movie) => movie.title.toLowerCase().includes(search.toLowerCase()) && movie.category === "Movie")
